*** Settings ***
Documentation   A Test Suite With Set Of Tests To Validate Switch Translation Mappings Trunk Parameters Screen Is Loading
...
Validate Click Submenu Of Switch Translation Mappings Menu
    [Tags]    BVT
    Verify Click Submenu Of Switch Translation Mappings Menu        Trunk Parameters

Validate Translate Page Title
    [Tags]  BVT
    Verify Title Of Translate Page      Trunk Parameters
