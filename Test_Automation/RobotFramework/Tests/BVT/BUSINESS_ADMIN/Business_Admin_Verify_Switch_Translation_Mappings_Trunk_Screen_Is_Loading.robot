*** Settings ***
Documentation   A Test Suite With Set Of Tests To Validate Switch Translation Mappings Trunk Screen Is Loading
...
Validate Click Submenu Of Switch Translation Mappings Menu
    [Tags]    BVT
    Verify Click Submenu Of Switch Translation Mappings Menu        Trunk

Validate Translate Page Title
    [Tags]  BVT
    Verify Title Of Translate Page      Switch Translation for Trunk
