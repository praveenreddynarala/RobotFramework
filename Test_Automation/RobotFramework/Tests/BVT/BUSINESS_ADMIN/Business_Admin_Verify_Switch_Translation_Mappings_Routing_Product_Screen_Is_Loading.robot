*** Settings ***
Documentation   A Test Suite With Set Of Tests To Validate Switch Translation Mappings Routing Product Screen Is Loading
...
Validate Click Submenu Of Switch Translation Mappings Menu
    [Tags]    BVT
    Verify Click Submenu Of Switch Translation Mappings Menu        Routing Product
