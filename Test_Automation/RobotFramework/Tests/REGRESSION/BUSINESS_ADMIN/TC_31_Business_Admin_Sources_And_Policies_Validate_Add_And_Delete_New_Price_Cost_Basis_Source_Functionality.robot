*** Settings ***
Documentation     A Test Suite With Set Of Tests For Business Admin Sources and Policies To Validate Add And Delete New Price Cost Basis Functionality
...
Validate Set Call Type
    [Tags]    REGRESSION
    Verify Set Call Type        ${CALL TYPE FOR ADD PRICE COST BASIS}
...
Validate Set Note
    [Tags]    REGRESSION
    Verify Set Note     ${NOTE FOR ADD PRICE COST BASIS}
...
Validate Call Type After Create
    [Tags]    REGRESSION
    Verify Call Type After Create       ${CALL TYPE FOR ADD PRICE COST BASIS}
...
Validate Note After Create
    [Tags]    REGRESSION
    Verify Note After Create        ${NOTE FOR ADD PRICE COST BASIS}
