*** Settings ***
Documentation     A Test Suite With Set Of Tests For Business Admin Sources and Policies To Validate Reference Account Bulk Edit Functionality
...
Validate Set Reference Account Bulk Edit Number Plan
    [Tags]    REGRESSION
    Verify Set Reference Account Bulk Edit Number Plan      ${NUMBER PLAN FOR REFERENCE ACCOUNT BULK EDIT}
