*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify If User Is Able To Assign All Countries To A Newly Created Country Group
...
Validate Click Country Groups Button For Sell
    [Tags]    REGRESSION
    Verify Click Country Groups Button
