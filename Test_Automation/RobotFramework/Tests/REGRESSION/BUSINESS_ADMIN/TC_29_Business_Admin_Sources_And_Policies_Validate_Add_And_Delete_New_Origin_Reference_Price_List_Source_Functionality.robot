*** Settings ***
Documentation     A Test Suite With Set Of Tests For Business Admin Sources and Policies To Validate Add And Delete New Origin Reference Price List Source Functionality
...
Validate Set Call Type
    [Tags]    REGRESSION
    Verify Set Call Type        ${CALL TYPE FOR ADD ORIGIN REFERENCE PRICE LIST}
...
Validate Get Origin Reference Price List Source Grid Row Data
    [Tags]    REGRESSION
...
Validate Call Type After Create
    [Tags]    REGRESSION
    Verify Call Type After Create       ${CALL TYPE FOR ADD ORIGIN REFERENCE PRICE LIST}

Validate Note After Create
    [Tags]    REGRESSION
    Verify Note After Create        ${NOTE FOR ADD ORIGIN REFERENCE PRICE LIST}
