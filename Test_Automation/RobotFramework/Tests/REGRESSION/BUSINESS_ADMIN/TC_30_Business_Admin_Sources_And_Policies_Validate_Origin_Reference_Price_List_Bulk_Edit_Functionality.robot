*** Settings ***
Documentation     A Test Suite With Set Of Tests For Business Admin Sources And Policies To Validate Origin Reference Price List Bulk Edit Functionality
...
Validate Set Bulk Edit Call Type
    [Tags]    REGRESSION
    Verify Set Bulk Edit Call Type      ${CALL TYPE FOR ORIGIN REFERENCE PRICE LIST BULK EDIT}
