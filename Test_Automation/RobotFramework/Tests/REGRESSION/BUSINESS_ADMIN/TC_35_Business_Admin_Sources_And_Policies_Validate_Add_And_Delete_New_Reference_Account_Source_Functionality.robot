*** Settings ***
Documentation     A Test Suite With Set Of Tests For Business Admin Sources and Policies To Validate Add And Delete New Reference Account Source Functionality
...
Validate Set Source Type For Search
    [Tags]    REGRESSION
    Verify Set Source Type For Search       ${REFERENCE ACCOUNT SOURCE TYPE}
...
Validate Set Number Plan
    [Tags]    REGRESSION
    Verify Set Number Plan      ${REFERENCE ACCOUNT SOURCE NUMBER PLAN}
...
Validate Set Note
    [Tags]    REGRESSION
    Verify Set Note     ${REFERENCE ACCOUNT SOURCE NOTE}
...
Validate Number Plan After Reference Account Create
    [Tags]    REGRESSION
    Verify Number Plan After Reference Account Create     ${REFERENCE ACCOUNT SOURCE NUMBER PLAN}

Validate Note After Create
    [Tags]    REGRESSION
    Verify Note After Create    ${REFERENCE ACCOUNT SOURCE NOTE}
...
Validate Click Add New Source Button After Delete
    [Tags]    REGRESSION
    Verify Click Add New Source Button
...
Validate Set Wholesale Solution Type For New Source
    [Tags]    REGRESSION
    Verify Set Wholesale Solution Type      ${WHOLESALE SOLUTION TYPE}
