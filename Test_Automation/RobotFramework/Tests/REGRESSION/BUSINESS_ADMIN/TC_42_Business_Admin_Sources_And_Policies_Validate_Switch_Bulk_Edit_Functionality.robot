*** Settings ***
Documentation     A Test Suite With Set Of Tests For Business Admin Sources & Policies Validate Switch Bulk Edit Functionality
...
Validate Set Source Type For Search
    [Tags]    REGRESSION
    Verify Set Source Type For Search       ${SOURCE TYPE FOR SWITCH BULK EDIT}
...
Validate Set Bulk Edit Call Type
    [Tags]    REGRESSION
    Verify Set Bulk Edit Call Type          ${CALL TYPE FOR SWITCH BULK EDIT}
