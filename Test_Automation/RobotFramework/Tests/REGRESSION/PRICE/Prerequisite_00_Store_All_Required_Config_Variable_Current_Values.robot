...
Validate Set iXTrade Scope
    [Tags]    REGRESSION
    Verify Set Scope    iXTrade

Validate Set Variable Name For AllowZerorates
    [Tags]    REGRESSION
    Verify Set Variable Name    AllowZerorates

Validate Click Configuration Variables Grid Search Button For AllowZerorates
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Store Preset Config Variable Current Value For AllowZerorates
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       AllowZerorates

Validate Store Preset Config Variable Modified By For AllowZerorates
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       AllowZerorates