*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate All Grid Related Actions Of Price Overrides Grid For Inline Item Functionality
...
Validate Select View Price Policy Inline Action Item
    [Tags]    REGRESSION
    Verify Select Inline Action Item        ${PRICE OVERRIDES INLINE ITEM}
...
Validate Get All Rows of Specific Column From Price Overrides Grid
    [Tags]    REGRESSION
    @{ALL ROW DATA} =   Verify Get All Rows of Specific Column From Price Overrides Grid     ${DESTINATION COLUMN NAME}
    set suite variable      @{ALL ROW DATA}

Validate Sort Price Overrides Grid Column In Descending Order
    [Tags]    REGRESSION
    Verify Sort Price Overrides Grid Column In Descending Order    ${DESTINATION COLUMN NAME}

Validate Get All Rows of Destination Column From Price Overrides For Descending Sort
    [Tags]    REGRESSION
    Verify Get All Rows of Specific Column From Price Overrides Grid    ${DESTINATION COLUMN NAME}
...
Validate Sort Price Overrides Grid Column In Ascending Order
    [Tags]    REGRESSION
    Verify Sort Price Overrides Grid Column In Ascending Order    ${DESTINATION COLUMN NAME}
...
Validate Drag Price Overrides Grid Column
    [Tags]    REGRESSION
    Verify Drag Price Overrides Grid Column    ${DESTINATION COLUMN NAME}    ${BEGIN DATE COLUMN NAME}
