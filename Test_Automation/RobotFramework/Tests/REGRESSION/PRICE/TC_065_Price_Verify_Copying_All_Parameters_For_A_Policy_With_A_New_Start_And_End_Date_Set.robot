*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify Copying All Parameters For A Policy With A New Start And End Date Set
...
*** Test Cases ***
Validate Navigate to Price module For First Price Policy
    [Tags]    REGRESSION
    Click on Home Icon and Select 'Price' From Main Menu

Validate Navigate to Price Policies Tab For First Price Policy
    [Tags]    REGRESSION
...
Vlidate Click Create New Price Policy For First Price Policy
    [Tags]    REGRESSION
    Verify Click Create New Cost Policy

Validate Set Price Policy Name For First Price Policy
    [Tags]    REGRESSION
    Verify Set Cost Policy Name     ${TEST DATA PREFIX}

Validate Set Abbreviation For First Price Policy
    [Tags]    REGRESSION
    Verify Set Cost Policy Abbreviation

Validate Set Price Policy Status For First Price Policy
    [Tags]    REGRESSION
    Verify Set Cost Policy Status       ${PRICE POLICY ACTIVE STATUS}

Validate Set Call Type For First Price Policy
    [Tags]    REGRESSION
...
Validate Set Route Class For First Price Policy
    [Tags]    REGRESSION
    Verify Set Cost Policy Route Class      ${ROUTE CLASS}

Validate Click Create Price Policy Save Button For First Price Policy
    [Tags]    REGRESSION
