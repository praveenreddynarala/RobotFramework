*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify If Call Text Is Displayed For Voice Parameters In Cost Forcast Elements
...
Validate The CCPMR Each Call Text Is Available In Info Column
    [Tags]    REGRESSION
...
Validate The CCPMR Each Call Text Is Available In Info Column After Setting InboundReferenceNumberPlanID To -2
    [Tags]    REGRESSION
    Verify The CCPMR Each Call Text Is Available In Info Column
