*** Settings ***
Documentation     [TAENOSIS-850] A Test Suite With Set Of Tests To Validate Cost Policies Show Correct Text When Cost Policy Is SMS
...
Validate Cost Forecast Elements Grid Description
    [Tags]    REGRESSION
    Verify Cost Forecast Elements Grid Description      Message