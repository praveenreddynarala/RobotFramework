*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Copy Parameter Functionality for Single User Defined Parameter
...
Validate Select User Defined Parameters Grid Row Checkbox
    [Tags]    REGRESSION
