...
Validate Reset Preset Config Variable Modified By For iXToolsWholesaleSolutionType
    [Tags]    REGRESSION
    Verify Clear Multiple Kendo Dropdown Selection      Scope
...
Validate Reset Preset Config Variable Current Value For AllowZerorates
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     AllowZerorates
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}