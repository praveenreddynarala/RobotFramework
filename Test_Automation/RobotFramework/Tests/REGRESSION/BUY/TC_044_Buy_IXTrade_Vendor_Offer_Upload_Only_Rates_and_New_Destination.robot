*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Only Rates and New Destination
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${ONLY RATES AND NEW DESTINATION FILE NAME}
