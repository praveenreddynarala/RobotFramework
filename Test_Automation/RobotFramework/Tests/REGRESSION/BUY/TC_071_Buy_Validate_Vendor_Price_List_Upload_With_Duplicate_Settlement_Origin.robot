*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload With Duplicate Settlement Origin
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${VENDOR PRICE LIST DUPLICATE SETTLEMENT ORIGIN TEMPLATE NAME}
