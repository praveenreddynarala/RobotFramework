*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload With Country Rating Method
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${VENDOR PRICE LIST COUNTRY RATING METHOD TEMPLATE NAME}
