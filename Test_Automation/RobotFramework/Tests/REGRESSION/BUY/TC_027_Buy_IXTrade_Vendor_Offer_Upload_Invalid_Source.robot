*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Invalid Source
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${INVALID SOURCE FILE NAME}
