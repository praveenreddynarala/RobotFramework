*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload With Missing Effective Date
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${VENDOR PRICE LIST MNISSING EFFECTIVE DATE TEMPLATE NAME}

Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${EFFECTIVE DATE UPLOAD FAILURE MESSAGE}
