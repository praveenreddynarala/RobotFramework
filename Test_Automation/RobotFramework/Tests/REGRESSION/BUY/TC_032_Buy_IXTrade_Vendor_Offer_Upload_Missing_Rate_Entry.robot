*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Missing Rate Entry
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${MISSING RATE ENTRY FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${MISSING RATE ENTRY ERROR MESSAGE}
