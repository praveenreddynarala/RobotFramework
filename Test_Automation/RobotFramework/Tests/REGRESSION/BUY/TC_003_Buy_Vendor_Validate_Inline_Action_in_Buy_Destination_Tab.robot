*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Inline Action In Buy - Destinations Tab
...
Validate Click On Destinations Tab
    [Tags]    REGRESSION
    Verify Click On Destinations Tab        ${DESTINATIONS TAB NAME}
