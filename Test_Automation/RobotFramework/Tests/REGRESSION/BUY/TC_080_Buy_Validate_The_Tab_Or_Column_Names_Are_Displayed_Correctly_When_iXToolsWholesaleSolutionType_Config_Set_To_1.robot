...
Validate Select Inline Action Item
    [Tags]    REGRESSION
    Verify Select Inline Action Item With Inline Item Name        ${VENDOR DIALED DIGITS INLINE ITEM NAME}

Validate The Dialed Digits Tab On Vendor Profile Page Is Available
    [Tags]    REGRESSION
    Verify The Specific Tab On Vendor Profile Page Is Available       ${DIALED DIGITS TAB NAME}

Validate The Dialed Digits Column On Vendor Profile Grid Is Available
    [Tags]    REGRESSION
    Verify The Specific Column On Vendor Profile Grid Is Available       ${DIALED DIGITS COLUMN NAME}