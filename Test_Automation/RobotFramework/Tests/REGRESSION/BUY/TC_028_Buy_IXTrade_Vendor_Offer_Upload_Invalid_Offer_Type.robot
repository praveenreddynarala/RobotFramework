*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Invalid Offer Type
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${INVALID OFFER TYPE FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${INVALID OFFER TYPE ERROR MESSAGE}
