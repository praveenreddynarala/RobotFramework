*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Invalid Offer Content
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${INVALID OFFERCONTENT FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${INVALID OFFER CONTENT ERROR MESSAGE}
