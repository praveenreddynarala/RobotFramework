*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload With Missing Dial Digit
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${VENDOR PRICE LIST MNISSING DIAL DIGIT TEMPLATE NAME}
...
Validate Failed Upload Info
    [Tags]    REGRESSION
    Verify Failed Upload Info       ${DIAL DIGIT FAILED UPLOAD INFO}
