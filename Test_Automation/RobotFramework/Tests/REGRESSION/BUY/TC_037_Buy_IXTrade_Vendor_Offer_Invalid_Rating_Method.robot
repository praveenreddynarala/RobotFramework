*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Invalid Rating Method
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${INVALID RATING METHOD FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${INVALID RATING METHOD ERROR MESSAGE}
