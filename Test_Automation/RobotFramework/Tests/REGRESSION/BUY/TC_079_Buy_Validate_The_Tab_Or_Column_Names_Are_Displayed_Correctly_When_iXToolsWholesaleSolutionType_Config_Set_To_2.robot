...
Validate Select Inline Action Item
    [Tags]    REGRESSION
    Verify Select Inline Action Item With Inline Item Name        ${VENDOR MCC-MNC INLINE ITEM NAME}

Validate The MCC-MNC Tab On Vendor Profile Page Is Available
    [Tags]    REGRESSION
    Verify The Specific Tab On Vendor Profile Page Is Available       ${MCC-MNC TAB NAME}

Validate The MCC-MNC Column On Vendor Profile Grid Is Available
    [Tags]    REGRESSION
    Verify The Specific Column On Vendor Profile Grid Is Available       ${MCC-MNC COLUMN NAME}