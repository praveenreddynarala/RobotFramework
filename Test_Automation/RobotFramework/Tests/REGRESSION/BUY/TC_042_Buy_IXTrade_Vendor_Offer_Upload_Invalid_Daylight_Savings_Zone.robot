*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Invalid Daylight Savings Zone
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${INVALID DAYLIGHT SAVINGS ZONE FILE NAME}
