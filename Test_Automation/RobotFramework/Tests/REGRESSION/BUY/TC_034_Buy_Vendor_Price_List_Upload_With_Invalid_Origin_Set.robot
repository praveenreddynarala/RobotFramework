*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload Invalid Origin Set
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${VENDOR PRICE LIST INVALID ORIGIN SET TEMPLATE NAME}
...
Validate Failed Upload Info
    [Tags]    REGRESSION
    Verify Failed Upload Info       ${INVALID SETTLEMENT ORIGIN FAILURE MESSAGE}
