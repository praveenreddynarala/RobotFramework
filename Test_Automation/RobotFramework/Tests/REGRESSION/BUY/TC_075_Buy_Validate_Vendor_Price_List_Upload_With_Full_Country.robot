*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload With Full Country
...
Validate Set Price List Content
    [Tags]    REGRESSION
    Verify Set Price List Content       ${FULL COUNTRY PRICE LIST CONTENT}
