*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Allow Future Effective Date
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${ALLOW FUTURE EFFECTIVE DATE FILE NAME}
