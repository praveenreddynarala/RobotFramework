*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Missing Dial Digits
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${MISSING DIAL DIGITS FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${MISSING DIAL DIGITS ERROR MESSAGE}
