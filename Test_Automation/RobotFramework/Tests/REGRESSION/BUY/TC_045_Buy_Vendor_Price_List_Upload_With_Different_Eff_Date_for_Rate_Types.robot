*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Vendor Price List Upload With Different Eff Date for Rates
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${VENDOR PRICE LIST DIFFERENT EFF DATE FOR RATES TEMPLATE NAME}
