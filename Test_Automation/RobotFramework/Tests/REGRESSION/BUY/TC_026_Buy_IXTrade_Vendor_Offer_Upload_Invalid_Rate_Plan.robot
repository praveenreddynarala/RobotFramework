*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Invalid Rate Plan
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${INVALID RATE PLAN FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${INVALID RATE PLAN ERROR MESSAGE}
