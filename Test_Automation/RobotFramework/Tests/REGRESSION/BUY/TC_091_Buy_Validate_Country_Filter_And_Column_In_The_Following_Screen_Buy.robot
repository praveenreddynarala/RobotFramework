*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Country Filter And Column In The Following Screen Buy
...
Validate navigate to Buy module After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Click on Home Icon and Select 'Buy' From Main Menu

Validate Click Re Analysis Link After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify Click Re Analysis Link

Validate The Country Selection Criteria Field Is Available In Re Analysis Page
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Re Analysis Page

Validate The Country Column Is Available In Re Analysis Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Re Analysis Page

Validate Close Re Analysis Tab After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    buy_page_resource.Verify Close Current Tab        ${RE ANALYSIS TAB NAME}

Validate Navigate To Vendors Tab After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify Click On Vendors Tab

Validate Filter Vendor Grid Colum After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify Filter Vendor Grid Column After Create        ${VENDOR COLUMN NAME}

Validate Click On Vendor Grid Inline Action Button After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify Click Vendors Grid First Row Inline Action Button

Validate Select Inline Action Item After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify Select Inline Action Item With Inline Item Name        ${VENDOR RATES INLINE ITEM NAME}

Validate The Country Selection Criteria Field Is Available In Vendor Profile Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Page

Validate Verify The Country Column Is Available In Vendor Profile Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
...
Validate The Country Selection Criteria Field Is Available In Vendor Profile Dialed Digits Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Dialed Digits Page

Validate The Country Column Is Available In Vendor Profile Dialed Digits Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
...
Validate The Country Selection Criteria Field Is Available In Vendor Profile Destinations Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Destinations Page

Validate The Country Column Is Available In Vendor Profile Destinations Page After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Destinations Page

Validate Close Vendor Profile Tab After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    buy_page_resource.Verify Close Current Tab        ${VENDOR PROFILE TAB NAME}

Validate Click On Vendor Price Lists After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
...
Validate Click On Vendor Price Lists Search Button After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
    Verify Click On Vendor Price Lists Search Button

Validate Click Vendor Price Lists Grid First Row Inline Action Button After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
...
Validate Select Reference Rates Tab After Setting iXTools To 1
    [Tags]    REGRESSION
    Verify Select Reference Rates Tab

Validate Click Search Ref Rates Arrow Button After Setting iXTools To 1
    [Tags]    REGRESSION
    Verify Click Search Ref Rates Arrow Button

Validate The Country Selection Criteria Field Is Available In View Price List Details Ref Rates Page After Setting iXTools To 1
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In View Price List Details Ref Rates Page

Validate The Country Column Is Available In View Price List Details Ref Rates Page After Setting iXTools To 1
    [Tags]    REGRESSION
...
Validate Select Vendor Price List Grid Row Checkbox After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
...
Validate Close Buy Window After Setting iXToolsWholesaleSolutionType To 1
    [Tags]    REGRESSION
...
Validate navigate to Buy module After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Click on Home Icon and Select 'Buy' From Main Menu

Validate Click Re Analysis Link After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Click Re Analysis Link

Validate The Country Selection Criteria Field Is Available In Re Analysis Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Re Analysis Page

Validate The Country Column Is Available In Re Analysis Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Re Analysis Page

Validate Close Re Analysis Tab After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    buy_page_resource.Verify Close Current Tab        ${RE ANALYSIS TAB NAME}

Validate Navigate To Vendors Tab After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Click On Vendors Tab

Validate Filter Vendor Grid Colum After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Filter Vendor Grid Column After Create        ${VENDOR COLUMN NAME}

Validate Click On Vendor Grid Inline Action Button After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Click Vendors Grid First Row Inline Action Button

Validate Select Inline Action Item After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Select Inline Action Item With Inline Item Name        ${VENDOR RATES INLINE ITEM NAME}

Validate The Country Selection Criteria Field Is Available In Vendor Profile Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Page

Validate Verify The Country Column Is Available In Vendor Profile Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Page
...
Validate The Country Selection Criteria Field Is Available In Vendor Profile Dialed Digits Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Dialed Digits Page

Validate The Country Column Is Available In Vendor Profile Dialed Digits Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Dialed Digits Page
...
Validate The Country Selection Criteria Field Is Available In Vendor Profile Destinations Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Destinations Page

Validate The Country Column Is Available In Vendor Profile Destinations Page After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Destinations Page

Validate Close Vendor Profile Tab After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    buy_page_resource.Verify Close Current Tab        ${VENDOR PROFILE TAB NAME}

Validate Click On Vendor Price Lists After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Click On Vendor Price Lists
...
Validate Click On Vendor Price Lists Search Button After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Click On Vendor Price Lists Search Button

Validate Click Vendor Price Lists Grid First Row Inline Action Button After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Click Vendor Price List Grid First Row Inline Action Button
...
Validate Select Reference Rates Tab After Setting iXTools To 2
    [Tags]    REGRESSION
    Verify Select Reference Rates Tab

Validate Click Search Ref Rates Arrow Button After Setting iXTools To 2
    [Tags]    REGRESSION
    Verify Click Search Ref Rates Arrow Button

Validate The Country Selection Criteria Field Is Available In View Price List Details Ref Rates Page After Setting iXTools To 2
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In View Price List Details Ref Rates Page

Validate The Country Column Is Available In View Price List Details Ref Rates Page After Setting iXTools To 2
    [Tags]    REGRESSION
    Verify The Country Column Is Available In View Price List Details Ref Rates Page
...
Validate Select Vendor Price List Grid Row Checkbox After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Select Vendor Price List Grid Row Checkbox
...
Validate Close Buy Window After Setting iXToolsWholesaleSolutionType To 2
    [Tags]    REGRESSION
    Verify Close Buy Window
...
Validate navigate to Buy module After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Click on Home Icon and Select 'Buy' From Main Menu

Validate Click Re Analysis Link After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Click Re Analysis Link

Validate The Country Selection Criteria Field Is Available In Re Analysis Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Re Analysis Page

Validate The Country Column Is Available In Re Analysis Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Re Analysis Page

Validate Close Re Analysis Tab After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    buy_page_resource.Verify Close Current Tab        ${RE ANALYSIS TAB NAME}

Validate Navigate To Vendors Tab After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Click On Vendors Tab

Validate Filter Vendor Grid Colum After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Filter Vendor Grid Column After Create        ${VENDOR COLUMN NAME}

Validate Click On Vendor Grid Inline Action Button After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Click Vendors Grid First Row Inline Action Button

Validate Select Inline Action Item After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Select Inline Action Item With Inline Item Name        ${VENDOR RATES INLINE ITEM NAME}

Validate The Country Selection Criteria Field Is Available In Vendor Profile Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Page

Validate Verify The Country Column Is Available In Vendor Profile Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Page
...
Validate The Country Selection Criteria Field Is Available In Vendor Profile Dialed Digits Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Dialed Digits Page

Validate The Country Column Is Available In Vendor Profile Dialed Digits Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Dialed Digits Page
...
Validate The Country Selection Criteria Field Is Available In Vendor Profile Destinations Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In Vendor Profile Destinations Page

Validate The Country Column Is Available In Vendor Profile Destinations Page After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify The Country Column Is Available In Vendor Profile Destinations Page

Validate Close Vendor Profile Tab After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    buy_page_resource.Verify Close Current Tab        ${VENDOR PROFILE TAB NAME}

Validate Click On Vendor Price Lists After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Click On Vendor Price Lists
...
Validate Click On Vendor Price Lists Search Button After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Click On Vendor Price Lists Search Button

Validate Click Vendor Price Lists Grid First Row Inline Action Button After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Click Vendor Price List Grid First Row Inline Action Button
...
Validate Select Reference Rates Tab After Setting iXTools To 3
    [Tags]    REGRESSION
    Verify Select Reference Rates Tab

Validate Click Search Ref Rates Arrow Button After Setting iXTools To 3
    [Tags]    REGRESSION
    Verify Click Search Ref Rates Arrow Button

Validate The Country Selection Criteria Field Is Available In View Price List Details Ref Rates Page After Setting iXTools To 3
    [Tags]    REGRESSION
    Verify The Country Selection Criteria Field Is Available In View Price List Details Ref Rates Page

Validate The Country Column Is Available In View Price List Details Ref Rates Page After Setting iXTools To 3
    [Tags]    REGRESSION
    Verify The Country Column Is Available In View Price List Details Ref Rates Page
...
Validate Select Vendor Price List Grid Row Checkbox After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Select Vendor Price List Grid Row Checkbox
...
Validate Close Buy Window After Setting iXToolsWholesaleSolutionType To 3
    [Tags]    REGRESSION
    Verify Close Buy Window
