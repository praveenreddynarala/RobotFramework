*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Offer Upload Duplicate Destination
...
Validate Select The File To Be Uploaded
    ...
    Verify Select The File To Be Uploaded        ${TEMPLATE PATH}/${CALL TYPE}/${INVALID TEMPLATES FOLDER}/${DUPLICATE DESTINATION FILE NAME}
...
Validate Upload Failure Message
    [Tags]    REGRESSION
    Verify Upload Failure Message       ${DUPLICATE DESTINATION ERROR MESSAGE}
