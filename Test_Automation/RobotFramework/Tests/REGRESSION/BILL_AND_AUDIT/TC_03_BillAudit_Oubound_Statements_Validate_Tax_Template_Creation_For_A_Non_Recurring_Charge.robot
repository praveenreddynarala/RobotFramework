*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Tax Template Creation For A Non Recurring Charge
...
Validate New Non Traffic Charge Is Added In The Grid
    [Tags]    REGRESSION
...
Validate Non Traffic Charges Grid Row Details
    [Tags]    REGRESSION
    Verify Non Traffic Charges Grid Row Details     ${ACCOUNTING CODE}      ${CHARGE CATEGORY}      ${CURRENCY NAME}     ${CHARGE AMOUNT}    ${CREATED TAX TEMPLATE NAME}
...
Validate New Non Traffic Charge Is Deleted
    [Tags]    REGRESSION
