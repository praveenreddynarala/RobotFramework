*** Settings ***
Documentation     A Test Suite With Set Of Tests For Inbound Statement To Validate The Winning Dispute Functionality
...
Validate Set Statement Status For Search
    [Tags]    REGRESSION
    Verify Set Statement Status For Search      @{DISPUTED STATUS LIST}

Validate Set Begin Date For Statement Search
    [Tags]    REGRESSION
    Verify Set Begin Date For Statement Search      ${BEGIN DATE FOR WINNING DISPUTE}

Validate Set End Date For Statement Search
    [Tags]    REGRESSION
    Verify Set End Date For Statement Search        ${END DATE FOR WINNING DISPUTE}
...
Validate Click Win Dispute Button
    [Tags]    REGRESSION
    Verify Click Win Dispute Button

Validate Set Discrepancy Source
    [Tags]    REGRESSION
    Verify Set Discrepancy Source       ${DISCREPANCY SOURCE TYPE}
...
Validate Resolutions Grid Row Data
    [Tags]    REGRESSION
    Verify Resolutions Grid Row Data        ${DISCREPANCY SOURCE TYPE}       ${WON RESOLUTION TYPE}
