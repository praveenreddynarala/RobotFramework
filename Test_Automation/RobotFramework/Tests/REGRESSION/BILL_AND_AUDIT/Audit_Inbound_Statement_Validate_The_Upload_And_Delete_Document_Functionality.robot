*** Settings ***
Documentation     A Test Suite With Set Of Tests For Inbound Statement To Validate The Upload And Delete Document Functionality
...
Validate Set Statement Status For Search
    [Tags]    REGRESSION
    Verify Set Statement Status For Search    @{DOCUMENT UPLOAD STATUS LIST}

Validate Set Begin Date For Search
    [Tags]    REGRESSION
    Verify Set Begin Date For Statement Search      ${DOCUMENT UPLOAD BEGIN DATE}

Validate Set End Date For Search
    [Tags]    REGRESSION
    Verify Set End Date For Statement Search        ${DOCUMENT UPLOAD END DATE}
...
Validate Set Document Keyword
    [Tags]    REGRESSION
    Verify Set Document Keyword     ${NEW DOCUMENT KEYWORD}

Validate Set Document Reference Number
    [Tags]    REGRESSION
    Verify Set Document Reference Number        ${NEW DOCUMENT REFERENCE NUMBER}

Validate Set Document Date
    [Tags]    REGRESSION
    Verify Set Document Date        ${NEW DOCUMENT DATE}

Validate Set Document Order
    [Tags]    REGRESSION
    Verify Set Document Order       ${NEW DOCUMENT ORDER}
...
Validate Select The File To Be Uploaded
    [Tags]    REGRESSION
    Verify Select File To Be Uploaded       ${FILE PATH FOR UPLOAD}
...
Validate Keywords After Create
    [Tags]    REGRESSION
    Verify Keywords After Create        ${NEW DOCUMENT KEYWORD}

Validate Order After Create
    [Tags]    REGRESSION
    Verify Order After Create       ${NEW DOCUMENT ORDER}

Validate Reference Number After Create
    [Tags]    REGRESSION
    Verify Reference Number After Create        ${NEW DOCUMENT REFERENCE NUMBER}

Validate Edit Value In Documents Grid Keywords Column
    [Tags]    REGRESSION
    Verify Set Value In Documents Grid      ${KEYWORDS COLUMN NAME}     ${DOCUMENT KEYWORD FOR EDIT}

Validate Edit Value In Documents Grid Order Column
    [Tags]    REGRESSION
    Verify Set Value In Documents Grid      ${ORDER COLUMN NAME}        ${DOCUMENT ORDER FOR EDIT}

Validate Edit Value In Documents Grid Reference Number Column
    [Tags]    REGRESSION
    Verify Set Value In Documents Grid      ${REFERENCE NUMBER COLUMN NAME}     ${DOCUMENT REFRENCE NUMBER FOR EDIT}
...
Validate Edit Value In Documents Grid Order Column For Cancel Edit
    [Tags]    REGRESSION
    Verify Set Value In Documents Grid      ${ORDER COLUMN NAME}        ${DOCUMENT ORDER FOR CANCEL EDIT}
