...
Validate Store Preset Config Variable Current Value For EnablePreClosedApprovedStatus
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       EnablePreClosedApprovedStatus

Validate Store Preset Config Variable Modified By For EnablePreClosedApprovedStatus
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       EnablePreClosedApprovedStatus
...
Validate Store Preset Config Variable Current Value For AutoTransitionPostedToApproved
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       AutoTransitionPostedToApproved

Validate Store Preset Config Variable Modified By For AutoTransitionPostedToApproved
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       AutoTransitionPostedToApproved