...
Validate Reset Preset Config Variable Current Value For ExportToiXLinkEnhancedWorkflow
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     ExportToiXLinkEnhancedWorkflow
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
...
Validate Reset Preset Config Variable Current Value For ShowFutureOfferAction
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     ShowFutureOfferAction
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
...
Validate Reset Preset Config Variable Current Value For ShowTotalAbsoluteAndPercentMargininCPE
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     ShowTotalAbsoluteAndPercentMargininCPE
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
...
Validate Reset Preset Config Variable Current Value For backDatePricingExceptiondays
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     backDatePricingExceptiondays
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
...
Validate Reset Preset Config Variable Current Value For ForwarddatePricingexceptiondays
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     ForwarddatePricingexceptiondays
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
...
Validate Reset Preset Config Variable Current Value For CPEBeginDateRPLValidation
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     CPEBeginDateRPLValidation
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
