*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate CPL Preview Screen Displays Preview Summary And Rates Section
...
Validate The Error Log Message Tab Is Available
    [Tags]    REGRESSION
...
Validate The Search Rate Is Available
    [Tags]    REGRESSION
