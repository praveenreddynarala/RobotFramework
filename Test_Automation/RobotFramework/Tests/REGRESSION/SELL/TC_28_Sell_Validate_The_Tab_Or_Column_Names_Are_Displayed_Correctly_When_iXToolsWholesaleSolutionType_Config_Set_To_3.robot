...
Validate Select Inline Action Item
    [Tags]    REGRESSION
    sell_page_resource.Verify Select Inline Action Item        ${CUSTOMER DIALED DIGITS-MCC-MNC INLINE ITEM}

Validate The Dialed Digits/MCC-MNC Tab On Customer Profile Page Is Available
    [Tags]    REGRESSION
    Verify The Specific Tab On Customer Profile Page Is Available       ${DIALED DIGITS-MCC-MNC TAB NAME}

Validate The Dialed Digits/MCC-MNC Column On Customer Profile Grid Is Available
    [Tags]    REGRESSION
    Verify The Specific Column On Customer Profile Grid Is Available       ${DIALED DIGITS-MCC-MNC COLUMN NAME}