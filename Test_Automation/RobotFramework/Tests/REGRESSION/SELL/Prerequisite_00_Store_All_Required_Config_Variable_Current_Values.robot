...
Validate Set Variable Name For ExportToiXLinkEnhancedWorkflow
    [Tags]    REGRESSION
    Verify Set Variable Name    ExportToiXLinkEnhancedWorkflow

Validate Click Configuration Variables Grid Search Button For ExportToiXLinkEnhancedWorkflow
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Store Preset Config Variable Current Value For ExportToiXLinkEnhancedWorkflow
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       ExportToiXLinkEnhancedWorkflow

Validate Store Preset Config Variable Modified By For ExportToiXLinkEnhancedWorkflow
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       ExportToiXLinkEnhancedWorkflow
...
Validate Store Preset Config Variable Modified By For General
    [Tags]    REGRESSION
    Verify Clear Multiple Kendo Dropdown Selection      Scope

# Variables for iXTrade scope

Validate Set Variable Name For ShowFutureOfferAction
    [Tags]    REGRESSION
    Verify Set Variable Name    ShowFutureOfferAction

Validate Click Configuration Variables Grid Search Button For ShowFutureOfferAction
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Store Preset Config Variable Current Value For ShowFutureOfferAction
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       ShowFutureOfferAction

Validate Store Preset Config Variable Modified By For ShowFutureOfferAction
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       ShowFutureOfferAction

Validate Set Variable Name For ShowTotalAbsoluteAndPercentMargininCPE
    [Tags]    REGRESSION
    Verify Set Variable Name    ShowTotalAbsoluteAndPercentMargininCPE

Validate Click Configuration Variables Grid Search Button For ShowTotalAbsoluteAndPercentMargininCPE
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Store Preset Config Variable Current Value For ShowTotalAbsoluteAndPercentMargininCPE
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       ShowTotalAbsoluteAndPercentMargininCPE

Validate Store Preset Config Variable Modified By For ShowTotalAbsoluteAndPercentMargininCPE
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       ShowTotalAbsoluteAndPercentMargininCPE
...
Validate Store Preset Config Variable Current Value For backDatePricingExceptiondays
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       backDatePricingExceptiondays

Validate Store Preset Config Variable Modified By For backDatePricingExceptiondays
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       backDatePricingExceptiondays
...
Validate Store Preset Config Variable Current Value For ForwarddatePricingexceptiondays
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       ForwarddatePricingexceptiondays

Validate Store Preset Config Variable Modified By For ForwarddatePricingexceptiondays
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       ForwarddatePricingexceptiondays

Validate Set Variable Name For CPEBeginDateRPLValidation
    [Tags]    REGRESSION
...
Validate Store Preset Config Variable Current Value For CPEBeginDateRPLValidation
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       CPEBeginDateRPLValidation

Validate Store Preset Config Variable Modified By For CPEBeginDateRPLValidation
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       CPEBeginDateRPLValidation
