*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify Last Modified Date Updated After Saving Date In Sell Customer Profile
...
Validate Navigate to Customer Tab After Activate Customer
    [Tags]    REGRESSION
    Click On Customer Tab
