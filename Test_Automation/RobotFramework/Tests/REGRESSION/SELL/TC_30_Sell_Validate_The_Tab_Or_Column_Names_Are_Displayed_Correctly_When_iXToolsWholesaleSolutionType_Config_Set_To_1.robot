*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate The Tab Or Column Names Are Displayed Correctly When iXToolsWholesaleSolutionType Config Set To 1
...
Validate Select Inline Action Item
    [Tags]    REGRESSION
    sell_page_resource.Verify Select Inline Action Item        ${CUSTOMER DIALED DIGITS INLINE ITEM NAME}

Validate The Dialed Digits Tab On Customer Profile Page Is Available
    [Tags]    REGRESSION
    Verify The Specific Tab On Customer Profile Page Is Available       ${DIALED DIGITS TAB NAME}

Validate The Dialed Digits Column On Customer Profile Grid Is Available
    [Tags]    REGRESSION
    Verify The Specific Column On Customer Profile Grid Is Available       ${DIALED DIGITS COLUMN NAME}