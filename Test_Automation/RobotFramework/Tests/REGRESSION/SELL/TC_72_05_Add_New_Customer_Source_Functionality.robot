*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Add New Customer Source Functionality
...
Validate Set Call Type
    ...
    business_admin_page_resource.Verify Set Call Type        ${CALL TYPE}
