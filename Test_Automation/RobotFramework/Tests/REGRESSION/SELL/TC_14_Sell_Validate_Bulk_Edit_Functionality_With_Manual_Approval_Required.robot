*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Bulk Edit Functionality With Manual Approval Required
...
Validate Set Select Date
    [Tags]    REGRESSION
    Verify Set Select Date      ${SELECT DATE FOR BULK EDIT}
