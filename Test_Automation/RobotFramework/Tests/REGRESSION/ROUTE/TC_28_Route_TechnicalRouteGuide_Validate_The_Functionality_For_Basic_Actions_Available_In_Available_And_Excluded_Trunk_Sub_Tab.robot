*** Settings ***
Documentation     A Test Suite With Set Of Tests For Route Technical Route Guide To Validate The Functionality For Basic Actions Available in Available and Excluded Trunk Sub Tab
...
Validate Click Technical Routing Grid First Row Routing Product Link For Available Trunks
    [Tags]    REGRESSION
    Verify Click Technical Routing Grid First Row Routing Product Link
