...
Validate Set New Country Buy Country Group
    [Tags]    REGRESSION
    Verify Set New Country Buy Country Group     ${NEW COUNTRY BUY COUNTRY GROUP}

Validate Set New Country Sell Country Group
    [Tags]    REGRESSION
    Verify Set New Country Sell Country Group     ${NEW COUNTRY SELL COUNTRY GROUP}
