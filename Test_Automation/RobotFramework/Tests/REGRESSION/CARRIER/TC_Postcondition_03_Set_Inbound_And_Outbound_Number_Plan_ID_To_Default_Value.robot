*** Settings ***
Documentation     A Test Suite With Set Of Tests To Set Inbound and Outbound Number Plan Id to Default Value
...
Validate Click Configuration Variables Grid Search Button For Outbound Reference Number Plan ID
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Set Value In Current Value Column For Outbound Reference Number Plan ID
    [Tags]    REGRESSION
    Verify Set Value In Current Value Column        -1
