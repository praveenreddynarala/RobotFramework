...
Validate Reset Preset Config Variable Current Value For EnableServiceLevelChangeWorkOrders
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     EnableServiceLevelChangeWorkOrders
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}