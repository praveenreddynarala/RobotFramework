*** Settings ***
Documentation    A Test Suite With Set Of Tests To Verify That You Can Remove The Create Carrier Button From The Carrier Tab
...
Validate Assign Roles To Profile
    [Tags]    REGRESSION
    Verify Assign Roles To Profile      @{CARRIER USER AND VIEWER}
...
Validate Create Carrier Button Is Present
    [Tags]    REGRESSION
