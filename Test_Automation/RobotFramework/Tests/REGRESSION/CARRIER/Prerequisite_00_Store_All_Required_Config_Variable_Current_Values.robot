...
# Variables for IXConnect scope

Validate Set iXConnect Scope
    [Tags]    REGRESSION
    Verify Set Scope    iXConnect

Validate Set Variable Name For EnableServiceLevelChangeWorkOrders
    [Tags]    REGRESSION
    Verify Set Variable Name    EnableServiceLevelChangeWorkOrders

Validate Click Configuration Variables Grid Search Button For EnableServiceLevelChangeWorkOrders
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Store Preset Config Variable Current Value For EnableServiceLevelChangeWorkOrders
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       EnableServiceLevelChangeWorkOrders

Validate Store Preset Config Variable Modified By For EnableServiceLevelChangeWorkOrders
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       EnableServiceLevelChangeWorkOrders
