*** Settings ***
Documentation    A Test Suite With Set Of Tests To Verify Reset EnablesaasGranularroles Configuration Value
...
Validate Set Value In Current Value Column
    [Tags]    REGRESSION
    Verify Set Value In Current Value Column        ${RESET SAAS GRANULAR ROLES VALUE}