*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify Overlapping Grace Period
...
Validate Set Variable Name To Set iXToolsWholesaleSolutionType
    [Tags]    REGRESSION
...
Validate Set Grace Period From Dropdown
    [Tags]    REGRESSION
    Verify Set Grace Period From Dropdown       ${GRACE PERIOD}

Validate Set Aggregation Group Grace Period
    [Tags]    REGRESSION
    Verify Set Aggregation Group Grace Period           1
