*** Settings ***
Documentation     A Test Suite With Set Of Tests To Create Complex Contract For Sms With Auto Extend Operational And Accounting
...
Validate Click Auto Extend Operational And Accounting Radio Button
    [Tags]    REGRESSION
