*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify Virtual Destination Mapping In UNP Report
...
Validate Move Available Virtual Countries To Destination
    [Tags]    REGRESSION
    Verify Move Available Virtual Countries To Destination      ${CONFIGURE NUMBER PLAN VIRTUAL COUNTRY}
...
Validate Set Unified Number Plan
    [Tags]    REGRESSION
    Verify Set Unified Number Plan      ${CARRIER NAME}     ${TRUNK NAME}         Analog
