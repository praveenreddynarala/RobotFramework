*** Settings ***
Documentation     A Test Suite With Set Of Tests To Create Complex Contract For Sms With Auto Extend Operational Only
...
Validate Click Auto Extend Operational Only Radio Button
    [Tags]    REGRESSION
