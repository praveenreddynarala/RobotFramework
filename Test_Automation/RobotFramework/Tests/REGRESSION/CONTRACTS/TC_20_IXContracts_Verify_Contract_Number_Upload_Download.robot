*** Settings ***
Documentation     A Test Suite With Set Of Tests To Verify Contract Number Upload Download
...
Validate Set Complex Contract Account
    [Tags]    REGRESSION
    Verify Set Complex Contract Account      ${CARRIER NAME}
...
Validate Set Complex Contract Locked Status
    [Tags]    REGRESSION
    Verify Set Complex Contract Locked Status       No

Validate Set Contract Begin Date For Search
    [Tags]    REGRESSION
    Verify Set Contract Begin Date For Search      ${EMPTY}

Validate Set Contract End Date For Search
    [Tags]    REGRESSION
    Verify Set Contract End Date For Search        ${EMPTY}
...
Validate Select Number Plan Tab
    [Tags]    REGRESSION
    Verify Select Number Plan Tab

Validate Verify Click Add Number Plan Grid First Row Export Button
    [Tags]    REGRESSION
