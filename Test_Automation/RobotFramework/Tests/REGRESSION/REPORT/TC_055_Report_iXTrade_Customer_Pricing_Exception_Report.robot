*** Settings ***
Documentation     [TAENOSIS-734] A Test Suite With Set Of Tests For Verify iXTrdae Customer Pricing Exception Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${CUSTOMER PRICING EXCEPTION REPORT SUBMENU}
