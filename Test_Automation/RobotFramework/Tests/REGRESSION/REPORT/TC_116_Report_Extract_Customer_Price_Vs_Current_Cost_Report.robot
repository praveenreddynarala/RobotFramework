*** Settings ***
Documentation     [TAENOSIS-812] A Test Suite With Set Of Tests For Verify Extract Customer Price Vs Current Cost Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${CUSTOMER PRICE VS CURRENT COST REPORT SUBMENU}
...
Validate The Specific Report Page Is Loaded Poperly
    [Tags]    REGRESSION
    Verify The Specific Report Page Is Loaded Poperly       Customer Price vs. Current Cost
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${CUSTOMER PRICE VS CURRENT COST REPORT SUBMENU}
