*** Settings ***
Documentation     [TAENOSIS-809] A Test Suite With Set Of Tests For Verify Extract Cost, Revenue And ASR Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${COST REVENUE AND ASR REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${COST REVENUE AND ASR REPORT SUBMENU}
