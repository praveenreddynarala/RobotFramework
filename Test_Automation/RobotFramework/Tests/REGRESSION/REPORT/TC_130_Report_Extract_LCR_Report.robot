*** Settings ***
Documentation     [TAENOSIS-822] A Test Suite With Set Of Tests For Verify Extract LCR Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${LCR REPORT SUBMENU}
...
Validate Set Report Group
    [Tags]    REGRESSION
    Verify Set Report Group     Route Guide Reports

Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${LCR REPORT SUBMENU}
...
Validate Click Specific Extract name From List For Yesterday
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${LCR REPORT SUBMENU}
...
Validate Click Extract Go Button For Yesterday
    [Tags]    REGRESSION
    Verify Click Extract Go Button
...
Validate Click Specific Extract Name Button For Yesterday
    [Tags]    REGRESSION
    Verify Click Specific Extract Name Button        ${EXTRACT NAME}

Validate Click Extract Delete Button For Yesterday
    [Tags]    REGRESSION
    Verify Click Extract Delete Button
...
Validate Click Specific Extract name From List For Day Before Yesterday
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${LCR REPORT SUBMENU}
...
Validate Click Extract Go Button For Day Before Yesterday
    [Tags]    REGRESSION
    Verify Click Extract Go Button
...
Validate Click Specific Extract Name Button For Day Before Yesterday
    [Tags]    REGRESSION
    Verify Click Specific Extract Name Button        ${EXTRACT NAME}

Validate Click Extract Delete Button For Day Before Yesterday
    [Tags]    REGRESSION
    Verify Click Extract Delete Button
