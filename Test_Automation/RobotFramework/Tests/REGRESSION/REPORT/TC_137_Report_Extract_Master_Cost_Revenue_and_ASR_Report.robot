*** Settings ***
Documentation     [TAENOSIS-929] A Test Suite With Set Of Tests To Verify Extract Master Cost, Revenue and ASR Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MASTER COST REVENUE AND ASR REPORT SUBMENU}

Validate Set Future Begin Date
    [Tags]    REGRESSION
    Verify Set Future Date as Extract Begin Date With Upper Case D      32
...
Validate Set Begin Date
    [Tags]    REGRESSION
    Verify Set Extract Begin Date With Upper Case D         1/1/2017
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MASTER COST REVENUE AND ASR REPORT SUBMENU}
