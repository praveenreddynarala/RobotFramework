*** Settings ***
Documentation     A Test Suite With Set Of Tests To Validate Upload functionality in Buy Vendor Price List
...
Validate Get Vendor Price Lists Details
    [Tags]    REGRESSION
    Verify Get Vendor Price Lists Details

Validate Uploaded Vendor Price List details on Database
    [Tags]    REGRESSION
    Verify Uploaded Vendor Price List details on Database           ${DATABASE SERVER}       ${DATABASE}     ${DATABASE USERNAME}        ${DATABASE PASSWORD}
...
Validate Vendor Price Lists Grid Details For Second Upload
    [Tags]    REGRESSION
    Verify Vendor Price Lists Grid Details

Validate Get Vendor Price Lists Details For Second Upload
    [Tags]    REGRESSION
    Verify Get Vendor Price Lists Details

Validate Uploaded Vendor Price List details on Database For Second Upload
    [Tags]    REGRESSION
    Verify Uploaded Vendor Price List details on Database           ${DATABASE SERVER}       ${DATABASE}     ${DATABASE USERNAME}        ${DATABASE PASSWORD}
