*** Settings ***
Documentation     [TAENOSIS-719] A Test Suite With Set Of Tests For Verify Network Port Usage Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${PORT USAGE REPORT SUBMENU}

Validate Set Switch
    [Tags]    REGRESSION
    Verify Set Switch       Sonus Paris
