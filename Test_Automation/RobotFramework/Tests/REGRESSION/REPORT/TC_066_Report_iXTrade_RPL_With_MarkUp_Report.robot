*** Settings ***
Documentation     [TAENOSIS-741] A Test Suite With Set Of Tests For Verify iXTrdae RPL With MarkUp Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${RPL WITH MARKUP REPORT SUBMENU}
...
Validate Set Currency
    [Tags]    REGRESSION
    ixreport_page_resource.Verify Set First Currency
