*** Settings ***
Documentation     [TAENOSIS-766] A Test Suite With Set Of Tests For Verify Diagnostic High Rate Report iXReport
...
Validate Expand Customer Profile Reports Section
    [Tags]    REGRESSION
    Verify Expand Reports Section       ${DIAGNOSTIC REPORTS MENU}

Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${HIGH RATE REPORT IXREPORT SUBMENU}
