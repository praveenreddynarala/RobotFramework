*** Settings ***
Documentation     [TAENOSIS-820] A Test Suite With Set Of Tests For Verify Extract In Out ASR Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${IN OUT ASR REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${IN OUT ASR REPORT SUBMENU}
