*** Settings ***
Documentation     [TAENOSIS-804] A Test Suite With Set Of Tests For Verify Extract Accrual Check Prev. Month
...
Validate Click Destination Breakout with Traffic Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${ACCRUAL CHECK PREV MONTH SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${ACCRUAL CHECK PREV MONTH SUBMENU}
