*** Settings ***
Documentation     [TAENOSIS-815] A Test Suite With Set Of Tests For Verify Extract Daily/Weekly Carrier Margin Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${DAILY WEEKLY CARRIER MARGIN REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${DAILY WEEKLY CARRIER MARGIN REPORT SUBMENU}
