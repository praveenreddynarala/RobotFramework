*** Settings ***
Documentation     [TAENOSIS-759] A Test Suite With Set Of Tests For Verify iXRoute Route Guide Override Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${ROUTE GUIDE OVERRIDE REPORT SUBMENU}
