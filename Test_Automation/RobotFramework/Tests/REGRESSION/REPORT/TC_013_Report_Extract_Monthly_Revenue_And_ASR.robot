*** Settings ***
Documentation     A Test Suite With Set Of Tests For Extract Monthly Revenue And ASR
...
Validate Click Destination Breakout with Traffic Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - Monthly Revenue and ASR
