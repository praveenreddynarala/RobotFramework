...
Validate Reset Preset Config Variable Current Value For AddTimeStampForOLAPExtracts
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     AddTimeStampForOLAPExtracts
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
...
Validate Reset Preset Config Variable Current Value For VOIPMOSEnabled
    [Tags]    REGRESSION
    ${PREVIOUS VALUE} =     Verify Get Preset Config Variable Current Value     VOIPMOSEnabled
    Verify Set Value In Current Value Column        ${PREVIOUS VALUE}
