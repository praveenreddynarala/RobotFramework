*** Settings ***
Documentation     [TAENOSIS-784] A Test Suite With Set Of Tests For Verify Extract Suspect Rate Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${SUSPECT RATE REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${SUSPECT RATE REPORT SUBMENU}
