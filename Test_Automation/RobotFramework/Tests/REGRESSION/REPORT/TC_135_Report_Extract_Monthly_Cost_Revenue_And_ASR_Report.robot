*** Settings ***
Documentation     [TAENOSIS-933] A Test Suite With Set Of Tests For Verify Extract Monthly Cost, Revenue and ASR Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MONTHLY COST REVENUE AND ASR REPORT SUBMENU}
...
Validate The Specific Report Page Is Loaded Poperly
    [Tags]    REGRESSION
    Verify The Specific Report Page Is Loaded Poperly       ${MONTHLY COST REVENUE AND ASR REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MONTHLY COST REVENUE AND ASR REPORT SUBMENU}
