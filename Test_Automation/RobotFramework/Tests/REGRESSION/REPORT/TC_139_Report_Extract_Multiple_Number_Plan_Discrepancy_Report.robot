*** Settings ***
Documentation     [TAENOSIS-945] A Test Suite With Set Of Tests To Verify Extract Multiple Number Plan Discrepancy Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MULTIPLE NUMBER PLAN DISCREPANCY REPORT SUBMENU}

Validate Click Extract Reference Set Browse Button
    [Tags]    REGRESSION
...
Validate Click Extract Comparis Set 1 Browse Button
    [Tags]    REGRESSION
...
Validate The Specific Report Page Is Loaded Poperly
    [Tags]    REGRESSION
    Verify The Specific Report Page Is Loaded Poperly       ${MULTIPLE NUMBER PLAN DISCREPANCY REPORT SUBMENU}
...
Validate Set Report Group
    [Tags]    REGRESSION
    Verify Set Report Group     ${IXTRADE REPORTS MENU}

Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MULTIPLE NUMBER PLAN DISCREPANCY REPORT SUBMENU}
