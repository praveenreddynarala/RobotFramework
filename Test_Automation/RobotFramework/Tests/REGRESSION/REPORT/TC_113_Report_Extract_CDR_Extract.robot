*** Settings ***
Documentation     [TAENOSIS-805] A Test Suite With Set Of Tests For Verify Extract CDR Extract
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${CDR EXTRACT SUBMENU}

Validate Set Begin Date
    [Tags]    REGRESSION
    Verify Set Extract Begin Date With Upper Case D         1/1/2016
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${CDR EXTRACT SUBMENU}
