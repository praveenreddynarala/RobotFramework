...
Validate Clear Multiple Kendo Dropdown Selection For General
    [Tags]    REGRESSION
    Verify Clear Multiple Kendo Dropdown Selection      Scope

# Variables for IXReport scope

Validate Set iXReport Scope
    [Tags]    REGRESSION
    Verify Set Scope    iXReport

Validate Set Variable Name For AddTimeStampForOLAPExtracts
    [Tags]    REGRESSION
    Verify Set Variable Name    AddTimeStampForOLAPExtracts

Validate Click Configuration Variables Grid Search Button For AddTimeStampForOLAPExtracts
    [Tags]    REGRESSION
    Verify Click Search Button

Validate Store Preset Config Variable Current Value For AddTimeStampForOLAPExtracts
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       AddTimeStampForOLAPExtracts

Validate Store Preset Config Variable Modified By For AddTimeStampForOLAPExtracts
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       AddTimeStampForOLAPExtracts

Validate Clear Multiple Kendo Dropdown Selection For IXReport
    [Tags]    REGRESSION
    Verify Clear Multiple Kendo Dropdown Selection      Scope

# Variables for iXRoute scope

Validate Set iXRoute Scope
    [Tags]    REGRESSION
    Verify Set Scope    iXRoute
...
Validate Store Preset Config Variable Current Value For VOIPMOSEnabled
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Current Value       VOIPMOSEnabled

Validate Store Preset Config Variable Modified By For VOIPMOSEnabled
    [Tags]    REGRESSION
    Verify Store Preset Config Variable Modified By       VOIPMOSEnabled