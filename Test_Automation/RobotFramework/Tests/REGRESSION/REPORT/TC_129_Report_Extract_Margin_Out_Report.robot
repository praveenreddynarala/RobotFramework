*** Settings ***
Documentation     [TAENOSIS-823] A Test Suite With Set Of Tests To Verify Extract Margin Out Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MARGIN OUT REPORT SUBMENU}
...
Validate Set Report Group
    [Tags]    REGRESSION
    Verify Set Report Group     ${DAILY OPERATIONAL REPORTS MENU}

Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MARGIN OUT REPORT SUBMENU}
