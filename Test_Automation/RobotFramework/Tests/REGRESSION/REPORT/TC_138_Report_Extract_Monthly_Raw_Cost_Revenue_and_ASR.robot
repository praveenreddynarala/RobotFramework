*** Settings ***
Documentation     [TAENOSIS-934] A Test Suite With Set Of Tests To Verify Extract Monthly Raw Cost, Revenue and ASR
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MONTHLY RAW COST REVENUE AND ASR SUBMENU}
...
Validate The Specific Report Page Is Loaded Poperly
    [Tags]    REGRESSION
    Verify The Specific Report Page Is Loaded Poperly       ${MONTHLY RAW COST REVENUE AND ASR SUBMENU}
...
Validate Set Report Group
    [Tags]    REGRESSION
    Verify Set Report Group     ${DIAGNOSTIC REPORTS MENU}

Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MONTHLY RAW COST REVENUE AND ASR REPORT LIST ITEM}
