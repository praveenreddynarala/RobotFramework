*** Settings ***
Documentation     [TAENOSIS-824] A Test Suite With Set Of Tests To Verify Extract Margin Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MARGIN REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MARGIN REPORT SUBMENU}
