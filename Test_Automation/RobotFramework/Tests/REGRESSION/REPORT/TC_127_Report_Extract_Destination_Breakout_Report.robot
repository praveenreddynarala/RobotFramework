*** Settings ***
Documentation     [TAENOSIS-817] A Test Suite With Set Of Tests For Verify Extract Destination Breakout Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${DESTINATION BREAKOUT REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${DESTINATION BREAKOUT REPORT SUBMENU}
