*** Settings ***
Documentation     [TAENOSIS-709] A Test Suite With Set Of Tests For Verify Bilateral Contract List Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${CONTRACT LIST REPORT SUBMENU}
