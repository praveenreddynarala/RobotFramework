*** Settings ***
Documentation     [TAENOSIS-801] A Test Suite With Set Of Tests To Verify DOR Cost Revenue And ASR Report Standard
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${COST REVENUE AND ASR REPORT SUBMENU}
...
Validate Expand Sub Report Item
    [Tags]    REGRESSION
    Verify Expand Sub Report Item       ${COST REVENUE AND ASR REPORT SUBMENU}
