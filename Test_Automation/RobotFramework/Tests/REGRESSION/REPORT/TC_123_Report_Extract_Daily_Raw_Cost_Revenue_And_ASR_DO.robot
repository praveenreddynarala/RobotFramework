*** Settings ***
Documentation     [TAENOSIS-814] A Test Suite With Set Of Tests For Verify Extract Daily Raw Cost Revenue And ASR (DO)
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${DAILY RAW COST REVENUE AND ASR DO SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${DAILY RAW COST REVENUE AND ASR DO SUBMENU}
