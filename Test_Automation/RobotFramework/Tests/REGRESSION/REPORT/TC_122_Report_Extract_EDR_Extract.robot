*** Settings ***
Documentation     [TAENOSIS-818] A Test Suite With Set Of Tests For Verify Extract EDR Extract
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${EDR EXTRACT SUBMENU}
...
Validate Set Extract Title
    [Tags]    REGRESSION
    Verify Set CDR Extract Title        ${TEST DATA PREFIX}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${EDR EXTRACT SUBMENU}
