*** Settings ***
Documentation     [TAENOSIS-930] A Test Suite With Set Of Tests For Verify Extract Monthly Carrier Margin Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MONTHLY CARRIER MARGIN REPORT SUBMENU}
...
Validate The Specific Report Page Is Loaded Poperly
    [Tags]    REGRESSION
    Verify The Specific Report Page Is Loaded Poperly       ${MONTHLY CARRIER MARGIN REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MONTHLY CARRIER MARGIN REPORT SUBMENU}
