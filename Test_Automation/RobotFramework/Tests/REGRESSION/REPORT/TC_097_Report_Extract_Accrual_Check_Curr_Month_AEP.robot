*** Settings ***
Documentation     [TAENOSIS-785] A Test Suite With Set Of Tests For Verify Extract Accrual Check Curr. Month AEP
...
Validate Click Destination Breakout with Traffic Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${ACCRUAL CHECK CURR MONTH AEP SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report   ${ACCRUAL CHECK CURR MONTH AEP SUBMENU}
