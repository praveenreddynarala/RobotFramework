*** Settings ***
Documentation     [TAENOSIS-803] A Test Suite With Set Of Tests For Verify Extract Accrual Check Curr. Month iXBill SEP
...
Validate Click Destination Breakout with Traffic Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${ACCRUAL CHECK CURR MONTH IXBILL SEP SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report   ${ACCRUAL CHECK CURR MONTH IXBILL SEP SUBMENU}
