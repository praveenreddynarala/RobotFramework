*** Settings ***
Documentation     [TAENOSIS-731] A Test Suite With Set Of Tests For Verify iXTrade Customer Price List Tracking Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${CUSTOMER PRICE LIST TRACKING REPORT SUBMENU}

Validate Set Future From Offer Date
    [Tags]    REGRESSION
    Verify Set Future Date Into Specific Date Field       From Offer Date       32
...
Validate Set From Offer Date
    [Tags]    REGRESSION
    Verify Set Date Value Into Specific Date Field      From Offer Date        1/1/2015
