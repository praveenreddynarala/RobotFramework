*** Settings ***
Documentation     [TAENOSIS-768] A Test Suite With Set Of Tests For Verify Customer Price Sheet Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${CUSTOMER PRICE SHEET REPORT SUBMENU}
