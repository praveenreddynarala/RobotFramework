*** Settings ***
Documentation     [TAENOSIS-808] A Test Suite With Set Of Tests For Verify Extract Cost And ASR Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${COST AND ASR REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${COST AND ASR REPORT SUBMENU}
