*** Settings ***
Documentation     [TAENOSIS-802] A Test Suite With Set Of Tests To Verify MOR Monthly Cost Revenue And ASR Standard
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${MONTHLY COST REVENUE AND ASR REPORT SUBMENU}

Validate Set First Level Summarize By
    [Tags]    REGRESSION
    Verify Set First Level Summarize By         ${AGGREGATE PRODUCT SUMMARIZE BY}

Validate Set Second Level Summarize By
    [Tags]    REGRESSION
    Verify Set Second Level Summarize By        ${CONTRACT SUMMARIZE BY}

Validate Set Third Level Summarize By
    [Tags]    REGRESSION
    Verify Set Third Level Summarize By         ${DESTINATION CATEGORY SUMMARIZE BY}

Validate Set Fourth Level Summarize By
    [Tags]    REGRESSION
    Verify Set Fourth Level Summarize By        ${IXTOOLS ACCOUNT SUMMARIZE BY}

Validate Set Fifth Level Summarize By
    [Tags]    REGRESSION
    Verify Set Fifth Level Summarize By         ${SETTLEMENT DESTINATION SUMMARIZE BY}

Validate Click Submit Button With ID
    [Tags]    REGRESSION
    Verify Click Submit Button With ID

Validate Monthly Cost Revenue and ASR Report Is Displayed
    [Tags]    REGRESSION
    Verify Specific Report Is Displayed        Monthly Cost, Revenue and ASR
...
Validate Set Extract Relative Period
    [Tags]    REGRESSION
    Verify Set Extract Relative Period      Current Month
...
Validate Expand Sub Report Item
    [Tags]    REGRESSION
    Verify Expand Sub Report Item       ${MONTHLY COST REVENUE AND ASR REPORT SUBMENU}
