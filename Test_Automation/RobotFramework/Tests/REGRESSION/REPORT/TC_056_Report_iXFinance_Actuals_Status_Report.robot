*** Settings ***
Documentation     [TAENOSIS-762] A Test Suite With Set Of Tests For Verify iXFinance Actuals Status Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${ACTUAL STATUS REPORT SUBMENU}

Validate Set Future Actual Create Begin Date
    [Tags]    REGRESSION
    Verify Set Future Date Into Specific Date Field       Actual Create Begin Date      32
...
Validate Set Actual Create Begin Date
    [Tags]    REGRESSION
    Verify Set Date Value Into Specific Date Field         Actual Create Begin Date        1/1/2015
