*** Settings ***
Documentation     [TAENOSIS-813] A Test Suite With Set Of Tests For Verify Extract Customer Specific Margin Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${CUSTOMER SPECIFIC MARGIN REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${CUSTOMER SPECIFIC MARGIN REPORT SUBMENU}
