*** Settings ***
Documentation     [TAENOSIS-928] A Test Suite With Set Of Tests To Verify Extract Margin In And Out Report
...
Validate Click Specific Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MARGIN IN AND OUT REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MARGIN IN AND OUT REPORT SUBMENU}
