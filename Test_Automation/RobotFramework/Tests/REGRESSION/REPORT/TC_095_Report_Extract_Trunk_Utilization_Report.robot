*** Settings ***
Documentation     [TAENOSIS-782] A Test Suite With Set Of Tests For Verify Extract Trunk Utilization Report
...
Validate Click Destination Breakout with Traffic Extract name From List
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${TRUNK UTILIZATION REPORT SUBMENU}
...
Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report   ${TRUNK UTILIZATION REPORT SUBMENU}
