*** Settings ***
Documentation     [TAENOSIS-807] A Test Suite With Set Of Tests For Verify Extract Cost Vs Destination
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${COST VS DESTINATION SUBMENU}
...
Validate Set Report Group
    [Tags]    REGRESSION
    Verify Set Report Group     ${VPR REPORTS MENU}

Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${COST VS DESTINATION SUBMENU}
