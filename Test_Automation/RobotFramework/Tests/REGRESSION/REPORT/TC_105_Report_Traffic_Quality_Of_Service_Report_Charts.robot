*** Settings ***
Documentation     [TAENOSIS-800] A Test Suite With Set Of Tests For Verify Traffic Quality Of Service Report Charts
...
Validate Set First Level Summarize By
    [Tags]    REGRESSION
    Verify Set First Level Summarize By         Call Date
...
Validate Click My Report Name To Verify Cancel Button
    [Tags]    REGRESSION
    Verify Click My Report Name     ${MY REPORT NAME}

Validate Click Myreport Cancel Button
    [Tags]    REGRESSION
