*** Settings ***
Documentation     [TAENOSIS-711] A Test Suite With Set Of Tests For Verify Bilateral Net Cost Report
...
Validate Click Sub Report Item
    [Tags]    REGRESSION
    Verify Click Sub Report Item        ${NET COST REPORT SUBMENU}
...
Validate Get Second Row Contract Name
    [Tags]    REGRESSION
    ${CONTRACT NAME} =       Verify Get Second Row Contract Name
