*** Settings ***
Documentation     [TAENOSIS-931] A Test Suite With Set Of Tests For Verify Extract Monthly Carrier Revenue and ASR Report
...
Validate Click Extract - Suspect Rate Report Submenu
    [Tags]    REGRESSION
    Verify Click Specific Extract name From List        Extract - ${MONTHLY CARRIER REVENUE AND ASR REPORT SUBMENU}
...
Validate The Specific Report Page Is Loaded Poperly
    [Tags]    REGRESSION
    Verify The Specific Report Page Is Loaded Poperly       ${MONTHLY CARRIER REVENUE AND ASR REPORT SUBMENU}
...
Validate Set Report Group
    [Tags]    REGRESSION
    Verify Set Report Group     ${OPERATION SALES REPORTS MENU}

Validate Set Report
    [Tags]    REGRESSION
    Verify Set Report       ${MONTHLY CARRIER REVENUE AND ASR REPORT SUBMENU}
