*** Settings ***
Documentation    A Test Suite With Set Of Tests To Validate If Job Maintenance_Screens Are Accessible When Job Maintenance User And Viewer Roles Are Assigned
...
Validate Assign Roles To Profile
    [Tags]    REGRESSION
    Verify Assign Roles To Profile      @{JOB MAINTENANCE USER AND VIEWER}
...
Validate The Job Maintenance Link Is Available
    [Tags]    REGRESSION
...
Validate Sign Out From Login Page
    [Tags]    REGRESSION
    Verify Log Out
