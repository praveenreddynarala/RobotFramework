*** Settings ***
Documentation    A Test Suite With Set Of Tests To Validate Alert Screens Are Accessible When Report User And Viewed Roles Are Assigned
...
Validate Assign Roles To Profile
    [Tags]    REGRESSION
    Verify Assign Roles To Profile      @{USER ROLE LIST FOR REPORT}
...
Validate Report Page Title
    [Tags]    REGRESSION
    report_page_resource.Verify Page Title
