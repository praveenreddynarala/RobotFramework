*** Settings ***
Documentation     A Test Suite With Set Of Tests For Smoke Testing Bill to Validate Navigation to Non Traffic Charges
...
Validate Non Traffic Charges Tab Is Loaded Properly
    [Tags]    SMOKE TESTING
