...
${OVERRIDE COMMERCIAL TRUNK}		UAT_AUTO_Trunk_O133WU/Commercial 	# Override commercial trunk, editable.
${OVERRIDE TRUNK}					UAT_AUTO_Trunk_O133WU 				# Override trunk, editable.
@{OVERRIDE TRUNK LIST}				UAT_AUTO_Trunk_O133WU 				# Override trunk list, editable.
...
@{OVERRIDE ROUTING PRODUCT LIST}	Afghanistan Mobile Roshan-ISDN-Flat		# Override routing product list, editable.
${OVERRIDE ROUTING PRODUCT}			Afghanistan Mobile Roshan-ISDN-Flat 	# Override routing product, editable.
...
@{INCLUSION TRUNK LIST}				UAT_AUTO_Trunk_EMA7TX/Commercial 		# Inclusion trunk list, editable.
${INCLUSION TRUNK}					UAT_AUTO_Trunk_EMA7TX 		            # Inclusion trunk, editable.
...
@{TECHNICAL OVERRIDE COMMERCIAL TRUNK}			UAT_AUTO_Trunk_S1ZMIJ/Commercial 	# Technical Override commercial trunk, editable.
@{TECHNICAL OVERRIDE TRUNK}				        UAT_AUTO_Trunk_S1ZMIJ 				# Technical Override trunk, editable.
...
@{TECHNICAL OVERRIDE ROUTING PRODUCT}		    Afghanistan Mobile-PSTN-Flat		# Technical Override routing product, editable.
