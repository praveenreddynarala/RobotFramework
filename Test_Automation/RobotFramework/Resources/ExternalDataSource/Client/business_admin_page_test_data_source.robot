...
${NUMBER PLAN UPLOAD FILE PATH}		C:/Templates/CustomerSpecificNumberPlanTemplate.xls 				# Number plan upload file path, editable.
...
${FILE PATH FOR UPLOAD ORIGIN SET}                     C:/Templates/OriginSetTemplate.xls                             # File path, editable.
...
@{COUNTRY LIST FOR ASSIGNING CATEGORIES}		        Afghanistan     Albania     Algeria		    # Country list, editable.
...
${COUNTRY GROUP SCOPE}                      Buy                         # Country group scope, editable.
${COUNTRY GROUP SCOPE FOR EDIT}             Sell                    # Country group scope for edit, editable.
...
${NEW COUNTRY BUY COUNTRY GROUP}        newCountryGroup     # Buy country group, editable.
${NEW COUNTRY SELL COUNTRY GROUP}       test23Sell          # Sell country group, editable.
${BULK EDIT BUY COUNTRY GROUP}          testGroup2          # Bulk edit buy country group, editable.
${BULK EDIT SELL COUNTRY GROUP}         test23Sell          # Bulk edit sell country group, editable.
